...
import { metaFormAddCollection } from '~/src/ui/modules/dynamic-data/components/form-add-collection/props';
import FormBuilder from '~/src/ui/shared/forms';
import Loading from '~/src/ui/shared/loading';

function FormAddCollection({ id }) {
    ...
    <>
      {loading ? (
        ...
        <Form form={form} onFinish={handleSubmit} className="site-page-content">
          <FormBuilder meta={metaFormAddCollection({ categories })} />
